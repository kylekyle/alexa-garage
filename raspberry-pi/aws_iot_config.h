...
// Fill this section in with your values
// =================================================
#define AWS_IOT_MQTT_HOST              "<your-id>-ats.iot.<your-region>.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "raspberry-pi" ///< MQTT client ID should be unique for every device
...
#define AWS_IOT_CERTIFICATE_FILENAME   "<cert-id>-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "<cert-id>-private.pem.key" ///< Device private key filename
// =================================================

// Change these if you are using different pins. Use wiring pi pin numbering
#define LEFT_GARAGE_DOOR_PIN 25
#define RIGHT_GARAGE_DOOR_PIN 24
...
#define AWS_IOT_MQTT_MAX_RECONNECT_WAIT_INTERVAL 1280000 ///< Maximum time interval after which exponential back-off will stop attempting to reconnect.
